...
ResizeWindow(position) {
    ...
    specialAppMap["wezterm-gui.exe"] := { "center_i": { "width": 2457, "height": 2004, "x_offset": (screenWidth - 2457) / 2, "y_offset": 43 }, "center_j": { "width": 1977, "height": 1645, "x_offset": (screenWidth - 1931) / 2, "y_offset": ((screenHeight - 1596) / 2 - 100) } }
    ; font size 11
