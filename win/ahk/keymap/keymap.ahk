...
ResizeWindow(position) {
    ...
    ; fancy tab bar
    specialAppMap["wezterm-gui.exe"] := { "center_i": { "width": 2457, "height": 2004, "x_offset": (screenWidth - 2457) / 2, "y_offset": 23 }, "center_j": { "width": 1928, "height": 1680, "x_offset": (screenWidth - 1931) / 2, "y_offset": (screenHeight - 1596) / 2 } }
