...
function obj:moveAndResize(option)
    ...
    if cwin then
        ...
        local wf = cwin:frame()
        options = {
            halfleft = function() cwin:setFrame({x=cres.x, y=cres.y, w=cres.w/2, h=cres.h}, 0) end,
            halfright = function() cwin:setFrame({x=cres.x+cres.w/2, y=cres.y, w=cres.w/2, h=cres.h}, 0) end,
            ...
            maximize = function() cwin:maximize(0) end,
