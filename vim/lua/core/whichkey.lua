...
local n_mappings = {
  ...
  f = {
    ...
    c = {":lua require('telescope.builtin').commands{}<cr>", 'colorscheme'},
    f = {":lua require('telescope.builtin').find_files{}<cr>", 'file'},
    g = {":lua require('telescope.builtin').resume{}<cr>", 'recall'},
    r = {":lua require('telescope.builtin').live_grep{}<cr>", 'rg'},
    b = {":lua require('telescope.builtin').buffers{}<cr>", 'buffer'},
    m = {":lua require('telescope.builtin').oldfiles{}<cr>", 'mru'},
