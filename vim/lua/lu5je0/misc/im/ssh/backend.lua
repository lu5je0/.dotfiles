...
M.insert = function()
  write(string.format("\27]1337;SetUserVar=%s=%s\7", "tui-bridge", require('lu5je0.misc.base64').encode('{"id":1,"module":"ime","method":"insert","params":{}}')))
end

M.normal = function()
  write(string.format("\27]1337;SetUserVar=%s=%s\7", "tui-bridge", require('lu5je0.misc.base64').encode('{"id":1,"module":"ime","method":"normal","params":{}}')))
end
