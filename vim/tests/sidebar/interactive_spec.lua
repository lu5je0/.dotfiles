...
--
-- Usage: cd vim && nvim --headless -u NONE -l tests/sidebar/interactive_spec.lua
...
local sidebar = require('lu5je0.ext.sidebar.init')
local state = require('lu5je0.ext.sidebar.state')
local config = require('lu5je0.ext.sidebar.config')
local navigation = require('lu5je0.ext.sidebar.actions.navigation')

for _, hl in ipairs(config.highlights) do
  vim.api.nvim_set_hl(0, hl[1], hl[2])
end

local _aug = vim.api.nvim_create_augroup('SidebarTest', { clear = true })
